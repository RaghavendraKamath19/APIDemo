...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>3ef957bd-8e8a-41b2-8214-0f8a69835e36</elementGuidId>
...
WS.verifyElementText(response, 'ListOfCountryNamesByNameResponse.ListOfCountryNamesByNameResult.tCountryCodeAndName[3].sISOCode', 'Albania')</verificationScript>
